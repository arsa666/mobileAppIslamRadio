...
//     alert(Ti.Network.remoteDeviceUUID);
//     alert(deviceToken);
...
subscribeButton.addEventListener('click', function () {
    ...
    if (deviceToken === null){
        ...
        alert('Ya usted esta registrado');
    }
...
function subscribeToChannel (e) {
    ...
    Cloud.PushNotifications.subscribeToken({
        ...
        if (e.success) {
            ...
            alert('Se ha registrado a radio jama correctamente, ahora recibira las notificaciones para esta radio.')
            Ti.API.info('Device Token subscribed: ' + e.deviceToken);
        } else {
            makeDisabled(unSubscribeButton);
            makeEnabledPushButton(subscribeButton);
            alert('Hubo un error en su registracion de radio jama, porfavor conectese al internet e intente denuevo.')
